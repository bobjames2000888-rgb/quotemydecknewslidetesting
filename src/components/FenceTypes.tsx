      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-base sm:text-xl text-white/70 max-w-3xl mx-auto px-4">
            Discover decking options tailored to your needs, budget, and style.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="card-gradient rounded-2xl p-8 shadow-soft border border-border">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Our expert team can help you select the perfect decking solution based on your specific needs, 
