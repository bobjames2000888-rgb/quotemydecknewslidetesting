...
// Canberra-specific stats
$stats = array(
    array('icon' => '👥', 'value' => '1,100+', 'label' => 'Jobs Quoted'),
    array('icon' => '⭐', 'value' => '4.8/5', 'label' => 'Average Rating'),
    array('icon' => '🕐', 'value' => '14+', 'label' => 'Years Experience'),
    array('icon' => '📍', 'value' => '120+', 'label' => 'Suburbs Serviced'),
);

// Canberra recent projects
...
<section class="hero-section">
    <div class="container">
        <div class="text-center" style="max-width: 900px; margin: 0 auto;">
            ...
            <p class="hero-description" style="margin: 0 auto 2rem;">Professional fencing installation and repair services across Greater <?php echo esc_html($city_name); ?>. Local tradies, trusted by 1,100+ <?php echo esc_html($city_name); ?> homeowners.</p>
...
<section style="padding: 5rem 0;">
    <div class="container">
        <div class="section-header text-center">
            ...
            <p>From Gungahlin to Tuggeranong, we've got <?php echo esc_html($city_name); ?> covered</p>
        </div>
        ...
        <div class="grid grid-2" style="align-items: center; gap: 3rem;">
            ...
            <div class="text-center">
                <div style="aspect-ratio: 4/3; border-radius: 1rem; overflow: hidden; box-shadow: 0 10px 30px -10px rgba(0,0,0,0.2);">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/canberra-fencing.webp" alt="<?php echo esc_html($city_name); ?> Fencing Projects" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
