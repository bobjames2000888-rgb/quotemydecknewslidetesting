<?php
/**
 * Template Part: Complete Suburb Page Content
 * This file contains all sections for suburb pages
 * Variables: $suburb_name must be defined before including
 * @package QuoteMyFence
 */

if (!isset($suburb_name)) {
    ...
    <div class="container" style="max-width: 900px;">
        ...
        <div class="faq-container">
            ...
            <div class="accordion-item">
                ...
                <div class="accordion-content">
                    Absolutely. Whether you need simple fence repairs (broken palings, leaning posts, storm damage) or a complete fence replacement, our <?php echo esc_html($suburb_name); ?> local fencing contractors can help. They'll inspect the fence, explain your repair-vs-replacement options, and provide honest advice for the most cost-effective solution.
                </div>
            </div>
            <div class="accordion-item">
                <button class="accordion-trigger" onclick="this.parentElement.classList.toggle('active')">
                ...
                <div class="accordion-content">
                    Within minutes, we'll match you with up to 3 qualified local fencing professionals in <?php echo esc_html($suburb_name); ?>. They'll contact you to discuss your job, arrange a site visit if required, and provide detailed written fencing quotes. You review the quotes, ask any questions, and choose the fencing contractor that best suits your project.
                </div>
            </div>
            <div class="accordion-item">
                <button class="accordion-trigger" onclick="this.parentElement.classList.toggle('active')">
                ...
                <div class="accordion-content">
                    Fence lifespan depends on the material and <?php echo esc_html($suburb_name); ?> area climate. A well-installed Colorbond fence or aluminium fence can last 20–30 years, while timber fencing generally lasts 10–20 years with proper care. Regular maintenance, high-quality installation, and choosing the right fencing material all play a major role.
                </div>
            </div>
            <div class="accordion-item">
                <button class="accordion-trigger" onclick="this.parentElement.classList.toggle('active')">
                ...
                <div class="accordion-content">
                    Yes — communication with your neighbour is essential. Boundary fences require both parties to agree on the fence height, materials, and cost sharing. In most cases, a quick conversation is enough to reach an agreement, and formal fencing notices are only needed if there's a dispute.
                </div>
            </div>
            <div class="accordion-item">
                <button class="accordion-trigger" onclick="this.parentElement.classList.toggle('active')">
                    <div class="accordion-number">11</div>
                    <span>How close to the boundary can I build my fence?</span>
                    <span class="accordion-icon">+</span>
                </button>
                <div class="accordion-content">
                    Most boundary fences are installed directly on the shared property line and are usually a shared cost between neighbours. To avoid disputes, it's best to check your boundary plan, title documents, or property survey before work begins.
                </div>
            </div>
            <div class="accordion-item">
                <button class="accordion-trigger" onclick="this.parentElement.classList.toggle('active')">
                    <div class="accordion-number">12</div>
                    <span>Can a new fence add value to my property?</span>
                    <span class="accordion-icon">+</span>
                </button>
                <div class="accordion-content">
                    Absolutely. A modern, high-quality fence can significantly improve your property's street appeal, privacy, and security — all of which add real value. It creates a stronger first impression, enhances outdoor spaces, and reduces future maintenance for potential buyers.
                </div>
            </div>
            <div class="accordion-item">
                <button class="accordion-trigger" onclick="this.parentElement.classList.toggle('active')">
                    <div class="accordion-number">13</div>
                    <span>How do I choose the right fence for my home in <?php echo esc_html($suburb_name); ?>?</span>
                    <span class="accordion-icon">+</span>
                </button>
                <div class="accordion-content">
                    Choosing the right fence depends on your home's style, privacy requirements and budget. Modern and contemporary homes often suit aluminium slat fencing or Colorbond, while classic or traditional properties typically look best with timber, picket, or decorative feature fencing. If you need maximum privacy, Colorbond or tall timber options work well. During your consultation, a local fencing contractor will assess your property and recommend the best materials based on appearance, durability, long-term value, and your goals.
                </div>
            </div>
            <div class="accordion-item">
                <button class="accordion-trigger" onclick="this.parentElement.classList.toggle('active')">
                    <div class="accordion-number">14</div>
                    <span>What factors can increase the total cost of a fence?</span>
                    <span class="accordion-icon">+</span>
                </button>
                <div class="accordion-content">
                    Aside from the fencing material itself, several factors can increase the total cost of a fence. These include site preparation, sloped or rocky ground, old fence removal, retaining requirements, custom designs, extra gates, and property accessibility issues. Your fencing contractors will outline all costs upfront during the quoting process so there are no surprises.
                </div>
            </div>
        </div>
        <!-- FAQ CTA -->
